...
wget --show-progress -qO /etc/enigma2/MultiStalkerPro.json "https://raw.githubusercontent.com/Ham-ahmed/38/refs/heads/main/MultiStalkerPro.json"
download=$?
echo ''
...
config.plugins.MultiStalkerPro.host=http://dragontv.pro:8080/
config.plugins.MultiStalkerPro.username=hany11223344
config.plugins.MultiStalkerPro.password=amro11223344
